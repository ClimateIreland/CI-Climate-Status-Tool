...
CHAPTERS = [
    ...
    },
    {
        ...
        'icon-hover-src': 'CO2_DropShadow_1.png',
        'domain': 'Atmosphere',
    ...
    },
    {
        ...
        'title': 'Methane',
        'href': '_2_11_Methane',
                'icon-lg-src': 'CH4_blue.png',
        'icon-lg-hover-src': 'CH4_White.png',
        'icon-src': 'CH4_White(50x50).png',
        'icon-hover-src': 'CH4_blue(50x50).png',
