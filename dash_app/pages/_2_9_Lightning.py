...
of storms. 
        """
bulletPoint1 = """
Variations of lightning frequency may be a consequence of climate change and 
an increase in the number of lightning events affects the climate directly by 
producing nitrogen oxides (NOx), which can react to form N\u2082O, a strong 
greenhouse gas.
        """
bulletPoint2 = """
...
strike, which can travel distances up to 10,000 km. The location of a 
...
trendChartTitle1 = '10-Day Accumulated Lightning Pulses'
...
The ATDnet system detects pulses at a frequency (10-14 kHz) known as 
VLF (Very Low Frequency). At this frequency, the pulses are called ‘sferics’.
