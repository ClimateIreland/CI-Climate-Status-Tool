...
trendChartTitle = 'Sea Subsurface Temperature - Rockall Trough' #(1961-2018)
...
20 Argo floats in the North Atlantic; these underwater autonomous profilers measure temperature and salinity down to a depth of 2000 m.
        """
