...
trendCaption1 = """
Heat map of 10-Day periods of average LAI over Ireland derived from the Copernicus Global Land Service (CGLS) datasets for the period 1999 to 2018. The data are presented as percentiles. For example, the 75th percentile means that 75% of all the values are below 3.07 and 25% of the values are above it.
        """
trendCaption2 = """
. Leaf Area Index (LAI) during four 10-day periods in 2018 derived from the Copernicus Global Land Service (CGLS) datasets.   © European Union, Copernicus Land Monitoring Service 2020, European Environment Agency (EEA).
    """
